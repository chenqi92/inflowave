...
#### Windows 用户
- **MSI 安装包 (推荐)**: 📥 **[InfloWave_0.9.0_x64_zh-CN.msi](https://github.com/chenqi92/inflowave/releases/download/v0.9.0/InfloWave_0.9.0_x64_zh-CN.msi)**
  - ✅ 适用于 Windows 10/11 (64位系统)
  - ✅ 企业级安装包，支持 GPO 部署
  - ✅ MSI 格式，系统信任度高

- **EXE 安装包**: 📥 **[InfloWave_0.9.0_x64-setup.exe](https://github.com/chenqi92/inflowave/releases/download/v0.9.0/InfloWave_0.9.0_x64-setup.exe)**
  - ✅ 适用于 Windows 10/11 (64位系统)
  - ✅ 用户友好的安装向导 (NSIS)
  - ✅ 支持中英文界面

- **32位 MSI**: 📥 **[InfloWave_0.9.0_x86_zh-CN.msi](https://github.com/chenqi92/inflowave/releases/download/v0.9.0/InfloWave_0.9.0_x86_zh-CN.msi)**
  - ✅ 适用于较老的32位 Windows 系统
  - ⚠️ 仅在无法运行64位版本时使用

- **32位 EXE**: 📥 **[InfloWave_0.9.0_x86-setup.exe](https://github.com/chenqi92/inflowave/releases/download/v0.9.0/InfloWave_0.9.0_x86-setup.exe)**
  - ✅ 适用于 Windows 7/8/10/11 (32位/64位)
  - ✅ 用户友好的安装向导 (NSIS)

- **便携版 (64位)**: 📥 **[InfloWave_0.9.0_x64_portable.zip](https://github.com/chenqi92/inflowave/releases/download/v0.9.0/InfloWave_0.9.0_x64_portable.zip)**
  - ✅ 免安装，解压即用
  - ✅ 适合 U 盘携带或无管理员权限场景
  - ✅ 不写入注册表，不影响系统

- **便携版 (32位)**: 📥 **[InfloWave_0.9.0_x86_portable.zip](https://github.com/chenqi92/inflowave/releases/download/v0.9.0/InfloWave_0.9.0_x86_portable.zip)**
  - ✅ 免安装，解压即用
  - ✅ 适用于 32 位系统
...
- 📥 **[InfloWave_0.9.0_amd64.deb](https://github.com/chenqi92/inflowave/releases/download/v0.9.0/InfloWave_0.9.0_amd64.deb)**
  ...
  - ✅ 系统集成度高，支持自动更新
  - 📋 安装命令: `sudo dpkg -i InfloWave_0.9.0_amd64.deb`
...
- 📥 **[InfloWave_0.9.0_amd64.AppImage](https://github.com/chenqi92/inflowave/releases/download/v0.9.0/InfloWave_0.9.0_amd64.AppImage)**
  ...
  - ✅ 免安装，下载后直接运行
  - ✅ 便携版，不影响系统
  - 📋 使用方法: `chmod +x InfloWave_0.9.0_amd64.AppImage && ./InfloWave_0.9.0_amd64.AppImage`
...
- 📥 **[InfloWave-0.9.0-1.x86_64.rpm](https://github.com/chenqi92/inflowave/releases/download/v0.9.0/InfloWave-0.9.0-1.x86_64.rpm)**
  ...
  - 📋 安装命令: `sudo rpm -i InfloWave-0.9.0-1.x86_64.rpm`
  - 📋 或使用: `sudo dnf install InfloWave-0.9.0-1.x86_64.rpm`
