...
#### Windows 用户
- **MSI 安装包 (推荐)**: 📥 **[InfloWave-0.5.4-x86_64.msi](https://github.com/chenqi92/inflowave/releases/download/v0.5.4/InfloWave-0.5.4-x86_64.msi)**
  - ✅ 适用于 Windows 10/11 (64位系统)
  - ✅ 企业级安装包，支持 GPO 部署
  - ✅ MSI 格式，系统信任度高

- **EXE 安装包**: 📥 **[InfloWave_0.5.4_x64-setup.exe](https://github.com/chenqi92/inflowave/releases/download/v0.5.4/InfloWave_0.5.4_x64-setup.exe)**
  - ✅ 适用于 Windows 10/11 (64位系统)
  - ✅ 用户友好的安装向导
  - ✅ 支持中英文界面

- **32位版本**: 📥 **[InfloWave-0.5.4-i686.msi](https://github.com/chenqi92/inflowave/releases/download/v0.5.4/InfloWave-0.5.4-i686.msi)**
...
**Intel Mac (Intel 处理器)**
- 📥 **[InfloWave_0.5.4_x64.dmg](https://github.com/chenqi92/inflowave/releases/download/v0.5.4/InfloWave_0.5.4_x64.dmg)**
  - ✅ 2020年前发布的 Mac
...
**Debian/Ubuntu 系列 (推荐)**
- 📥 **[inflowave_0.5.1_amd64.deb](https://github.com/chenqi92/inflowave/releases/download/v0.5.4/inflowave_0.5.1_amd64.deb)**
...
**通用 Linux (万能选择)**
- 📥 **[inflowave_0.5.1_amd64.AppImage](https://github.com/chenqi92/inflowave/releases/download/v0.5.4/inflowave_0.5.1_amd64.AppImage)**
...
- 📥 **[inflowave-0.5.1-1.x86_64.rpm](https://github.com/chenqi92/inflowave/releases/download/v0.5.4/inflowave-0.5.1-1.x86_64.rpm)**
