...
#### Windows 用户
- **MSI 安装包 (推荐)**: 📥 **[InflowWave_0.9.5_x64_zh-CN.msi](https://github.com/chenqi92/inflowave/releases/download/v0.9.5/InflowWave_0.9.5_x64_zh-CN.msi)**
  - ✅ 适用于 Windows 10/11 (64位系统)
  - ✅ 企业级安装包，支持 GPO 部署
  - ✅ MSI 格式，系统信任度高

- **EXE 安装包**: 📥 **[InflowWave_0.9.5_x64-setup.exe](https://github.com/chenqi92/inflowave/releases/download/v0.9.5/InflowWave_0.9.5_x64-setup.exe)**
  - ✅ 适用于 Windows 10/11 (64位系统)
  - ✅ 用户友好的安装向导 (NSIS)
  - ✅ 支持中英文界面

- **32位 MSI**: 📥 **[InflowWave_0.9.5_x86_zh-CN.msi](https://github.com/chenqi92/inflowave/releases/download/v0.9.5/InflowWave_0.9.5_x86_zh-CN.msi)**
  - ✅ 适用于较老的32位 Windows 系统
  - ⚠️ 仅在无法运行64位版本时使用

- **32位 EXE**: 📥 **[InflowWave_0.9.5_x86-setup.exe](https://github.com/chenqi92/inflowave/releases/download/v0.9.5/InflowWave_0.9.5_x86-setup.exe)**
...
- 📥 **[InflowWave_0.9.5_amd64.deb](https://github.com/chenqi92/inflowave/releases/download/v0.9.5/InflowWave_0.9.5_amd64.deb)**
  ...
  - ✅ 系统集成度高，支持自动更新
  - 📋 安装命令: `sudo dpkg -i InflowWave_0.9.5_amd64.deb`
...
- 📥 **[InflowWave_0.9.5_amd64.AppImage](https://github.com/chenqi92/inflowave/releases/download/v0.9.5/InflowWave_0.9.5_amd64.AppImage)**
  ...
  - ✅ 免安装，下载后直接运行
  - ✅ 便携版，不影响系统
  - 📋 使用方法: `chmod +x InflowWave_0.9.5_amd64.AppImage && ./InflowWave_0.9.5_amd64.AppImage`
...
- 📥 **[InflowWave-0.9.5-1.x86_64.rpm](https://github.com/chenqi92/inflowave/releases/download/v0.9.5/InflowWave-0.9.5-1.x86_64.rpm)**
  ...
  - 📋 安装命令: `sudo rpm -i InflowWave-0.9.5-1.x86_64.rpm`
  - 📋 或使用: `sudo dnf install InflowWave-0.9.5-1.x86_64.rpm`
