...
#### Windows 用户
- **推荐**: 📥 **[InfloWave_0.3.8_x64_zh-CN.msi](https://github.com/chenqi92/inflowave/releases/download/v0.3.8/InfloWave_0.3.8_x64_zh-CN.msi)** 
  - ✅ 适用于 Windows 10/11 (64位系统)
  - ✅ 支持大部分现代 Windows 系统
  - ✅ MSI 格式，安装简单可靠

- **兼容版**: 📥 **[InfloWave_0.3.8_x86_zh-CN.msi](https://github.com/chenqi92/inflowave/releases/download/v0.3.8/InfloWave_0.3.8_x86_zh-CN.msi)**
...
- 📥 **[InfloWave_0.3.8_amd64.deb](https://github.com/chenqi92/inflowave/releases/download/v0.3.8/InfloWave_0.3.8_amd64.deb)**
  ...
  - ✅ 系统集成度高，支持自动更新
  - 📋 安装命令: `sudo dpkg -i InfloWave_0.3.8_amd64.deb`
...
- 📥 **[InfloWave_0.3.8_amd64.AppImage](https://github.com/chenqi92/inflowave/releases/download/v0.3.8/InfloWave_0.3.8_amd64.AppImage)**
  ...
  - ✅ 免安装，下载后直接运行
  - ✅ 便携版，不影响系统
  - 📋 使用方法: `chmod +x InfloWave_0.3.8_amd64.AppImage && ./InfloWave_0.3.8_amd64.AppImage`
...
- 📥 **[InfloWave-0.3.8-1.x86_64.rpm](https://github.com/chenqi92/inflowave/releases/download/v0.3.8/InfloWave-0.3.8-1.x86_64.rpm)**
  ...
  - 📋 安装命令: `sudo rpm -i InfloWave-0.3.8-1.x86_64.rpm`
  - 📋 或使用: `sudo dnf install InfloWave-0.3.8-1.x86_64.rpm`
