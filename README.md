...
#### Windows 用户
- **MSI 安装包 (推荐)**: 📥 **[InfloWave-0.6.9-x86_64.msi](https://github.com/chenqi92/inflowave/releases/download/v0.6.9/InfloWave-0.6.9-x86_64.msi)**
  - ✅ 适用于 Windows 10/11 (64位系统)
  - ✅ 企业级安装包，支持 GPO 部署
  - ✅ MSI 格式，系统信任度高

- **EXE 安装包**: 📥 **[InfloWave_0.6.9_x64-setup.exe](https://github.com/chenqi92/inflowave/releases/download/v0.6.9/InfloWave_0.6.9_x64-setup.exe)**
  - ✅ 适用于 Windows 10/11 (64位系统)
  - ✅ 用户友好的安装向导
  - ✅ 支持中英文界面

- **32位版本**: 📥 **[InfloWave-0.6.9-i686.msi](https://github.com/chenqi92/inflowave/releases/download/v0.6.9/InfloWave-0.6.9-i686.msi)**
  - ✅ 适用于较老的32位 Windows 系统
  - ⚠️ 仅在无法运行64位版本时使用

**便携版 (免安装)**

- **64位便携版**: 📥 **[InfloWave-x64-portable-0.6.9.exe](https://github.com/chenqi92/inflowave/releases/download/v0.6.9/InfloWave-x64-portable-0.6.9.exe)**
  - ✅ 绿色软件，无需安装
  - ✅ 不写入注册表，不留痕迹
  - ✅ 便于携带，可放在U盘中
  - ✅ 适用于 Windows 10/11 (64位)

- **32位便携版**: 📥 **[InfloWave-x86-portable-0.6.9.exe](https://github.com/chenqi92/inflowave/releases/download/v0.6.9/InfloWave-x86-portable-0.6.9.exe)**
  - ✅ 绿色软件，无需安装
  - ✅ 兼容性更好，支持老旧系统
...
- 📥 **[InfloWave_0.6.9_aarch64.dmg](https://github.com/chenqi92/inflowave/releases/download/v0.6.9/InfloWave_0.6.9_aarch64.dmg)**
  - ✅ 2020年11月后发布的 Mac
  - ✅ 性能最优，原生支持
  - ✅ 更低的电量消耗
  - ⚠️ **无法在 Intel Mac 上运行**
...
**Intel Mac (Intel 处理器)**
- 📥 **[InfloWave_0.6.9_x64.dmg](https://github.com/chenqi92/inflowave/releases/download/v0.6.9/InfloWave_0.6.9_x64.dmg)**
  - ✅ 2020年前发布的 Mac
...
**Debian/Ubuntu 系列 (推荐)**
- 📥 **[inflowave_0.6.9_amd64.deb](https://github.com/chenqi92/inflowave/releases/download/v0.6.9/inflowave_0.6.9_amd64.deb)**
  - ✅ Ubuntu 18.04+, Debian 10+
  - ✅ 系统集成度高，支持自动更新
  - 📋 安装命令: `sudo dpkg -i inflowave_0.6.9_amd64.deb`
  - 🔧 依赖修复: `sudo apt-get install -f`

**通用 Linux (万能选择)**
- 📥 **[inflowave_0.6.9_amd64.AppImage](https://github.com/chenqi92/inflowave/releases/download/v0.6.9/inflowave_0.6.9_amd64.AppImage)**
  - ✅ 适用于大部分 x64 Linux 发行版
  - ✅ 免安装，下载后直接运行
  - ✅ 便携版，不影响系统
  - 📋 使用方法: `chmod +x inflowave_0.6.9_amd64.AppImage && ./inflowave_0.6.9_amd64.AppImage`

**RPM 系列 (CentOS/RHEL/Fedora)**
- 📥 **[inflowave-0.6.9-1.x86_64.rpm](https://github.com/chenqi92/inflowave/releases/download/v0.6.9/inflowave-0.6.9-1.x86_64.rpm)**
  - ✅ CentOS 7+, RHEL 7+, Fedora 30+
  - 📋 安装命令: `sudo rpm -i inflowave-0.6.9-1.x86_64.rpm`
  - 📋 或使用: `sudo dnf install inflowave-0.6.9-1.x86_64.rpm`
