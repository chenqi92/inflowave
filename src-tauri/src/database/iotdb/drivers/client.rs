...
impl TSInsertTabletReq {
  pub fn new<F8, F9, F10>(session_id: i64, prefix_path: String, measurements: Vec<String>, values: Vec<u8>, timestamps: Vec<u8>, types: Vec<i32>, size: i32, is_aligned: F8, write_to_table: F9, column_categories: F10) -> TSInsertTabletReq where F8: Into<Option<bool>>, F9: Into<Option<bool>>, F10: Into<Option<Vec<i8>>> {
    TSInsertTabletReq {
      session_id,
      prefix_path,
      measurements,
    ...
    loop {
      ...
      match field_id {
        ...
        6 => {
          ...
          for _ in 0..list_ident.size {
            let list_ident = i_prot.read_list_begin()?;
            let mut list_elem_33: Vec<i32> = Vec::with_capacity(list_ident.size as usize);
            for _ in 0..list_ident.size {
              let list_elem_34 = i_prot.read_i32()?;
    ...
    loop {
      ...
      match field_id {
        ...
        3 => {
          ...
          for _ in 0..list_ident.size {
            let list_ident = i_prot.read_list_begin()?;
            let mut list_elem_45: Vec<String> = Vec::with_capacity(list_ident.size as usize);
            for _ in 0..list_ident.size {
              let list_elem_46 = i_prot.read_string()?;
              list_elem_45.push(list_elem_46);
            }
            i_prot.read_list_end()?;
        ...
        5 => {
          ...
          let mut val: Vec<i64> = Vec::with_capacity(list_ident.size as usize);
          for _ in 0..list_ident.size {
            let list_elem_49 = i_prot.read_i64()?;
    ...
    loop {
      ...
      match field_id {
        ...
        3 => {
          ...
          for _ in 0..list_ident.size {
            let list_ident = i_prot.read_list_begin()?;
            let mut list_elem_51: Vec<String> = Vec::with_capacity(list_ident.size as usize);
            for _ in 0..list_ident.size {
              let list_elem_52 = i_prot.read_string()?;
              list_elem_51.push(list_elem_52);
            }
            i_prot.read_list_end()?;
        ...
        4 => {
          ...
          for _ in 0..list_ident.size {
            let list_ident = i_prot.read_list_begin()?;
            let mut list_elem_53: Vec<String> = Vec::with_capacity(list_ident.size as usize);
            for _ in 0..list_ident.size {
              let list_elem_54 = i_prot.read_string()?;
              list_elem_53.push(list_elem_54);
            }
            i_prot.read_list_end()?;
        ...
        5 => {
          ...
          let mut val: Vec<i64> = Vec::with_capacity(list_ident.size as usize);
          for _ in 0..list_ident.size {
            let list_elem_55 = i_prot.read_i64()?;
    ...
    loop {
      ...
      match field_id {
        ...
        8 => {
          ...
          let mut val: BTreeMap<String, String> = BTreeMap::new();
          for _ in 0..map_ident.size {
            let map_key_61 = i_prot.read_string()?;
            let map_val_62 = i_prot.read_string()?;
    ...
    loop {
      ...
      match field_id {
        ...
        4 => {
          ...
          for _ in 0..list_ident.size {
            let list_elem_78 = common::TAggregationType::read_from_in_protocol(i_prot)?;
    ...
    loop {
      ...
      match field_id {
        ...
        8 => {
          ...
          for _ in 0..list_ident.size {
            let map_ident = i_prot.read_map_begin()?;
            let mut list_elem_89: BTreeMap<String, String> = BTreeMap::new();
            for _ in 0..map_ident.size {
              let map_key_90 = i_prot.read_string()?;
              let map_val_91 = i_prot.read_string()?;
              list_elem_89.insert(map_key_90, map_val_91);
            }
            i_prot.read_map_end()?;
    ...
    loop {
      ...
      match field_id {
        ...
        6 => {
          ...
          let mut val: Vec<i32> = Vec::with_capacity(list_ident.size as usize);
          for _ in 0..list_ident.size {
            let list_elem_96 = i_prot.read_i32()?;
    ...
    loop {
      ...
      match field_id {
        ...
        4 => {
          ...
          let mut val: Vec<Vec<u8>> = Vec::with_capacity(list_ident.size as usize);
          for _ in 0..list_ident.size {
            let list_elem_100 = i_prot.read_bytes()?;
    ...
    loop {
      ...
      match field_id {
        1 => {
          ...
          for _ in 0..list_ident.size {
            let list_elem_101 = TSConnectionInfo::read_from_in_protocol(i_prot)?;
