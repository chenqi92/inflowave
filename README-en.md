...
#### Windows Users
- **Recommended**: 📥 **[InfloWave_0.3.0_x64.msi](https://github.com/chenqi92/inflowave/releases/download/v0.3.0/InfloWave_0.3.0_x64.msi)** 
  - ✅ For Windows 10/11 (64-bit systems)
  - ✅ Supports most modern Windows systems
  - ✅ MSI format, simple and reliable installation

- **Legacy**: 📥 **[InfloWave_0.3.0_x86.msi](https://github.com/chenqi92/inflowave/releases/download/v0.3.0/InfloWave_0.3.0_x86.msi)**
...
- 📥 **[InfloWave_0.3.0_amd64.deb](https://github.com/chenqi92/inflowave/releases/download/v0.3.0/InfloWave_0.3.0_amd64.deb)**
  ...
  - 📋 Install command: `sudo dpkg -i InfloWave_0.3.0_amd64.deb`
...
- 📥 **[InfloWave_0.3.0_amd64.AppImage](https://github.com/chenqi92/inflowave/releases/download/v0.3.0/InfloWave_0.3.0_amd64.AppImage)**
  ...
  - 📋 Usage: `chmod +x InfloWave_0.3.0_amd64.AppImage && ./InfloWave_0.3.0_amd64.AppImage`
...
- 📥 **[InfloWave-0.3.0-1.x86_64.rpm](https://github.com/chenqi92/inflowave/releases/download/v0.3.0/InfloWave-0.3.0-1.x86_64.rpm)**
  ...
  - 📋 Install command: `sudo rpm -i InfloWave-0.3.0-1.x86_64.rpm`
  - 📋 Or use: `sudo dnf install InfloWave-0.3.0-1.x86_64.rpm`
