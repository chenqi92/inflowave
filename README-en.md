...
#### Windows Users
- **Recommended**: 📥 **[InfloWave_0.5.2_x64.msi](https://github.com/chenqi92/inflowave/releases/download/v0.5.2/InfloWave_0.5.2_x64.msi)** 
  - ✅ For Windows 10/11 (64-bit systems)
  - ✅ Supports most modern Windows systems
  - ✅ MSI format, simple and reliable installation

- **Legacy**: 📥 **[InfloWave_0.5.2_x86.msi](https://github.com/chenqi92/inflowave/releases/download/v0.5.2/InfloWave_0.5.2_x86.msi)**
...
- 📥 **[InfloWave_0.5.2_aarch64.dmg](https://github.com/chenqi92/inflowave/releases/download/v0.5.2/InfloWave_0.5.2_aarch64.dmg)**
...
- 📥 **[InfloWave_0.5.2_amd64.deb](https://github.com/chenqi92/inflowave/releases/download/v0.5.2/InfloWave_0.5.2_amd64.deb)**
  - ✅ Ubuntu 18.04+, Debian 10+
  - ✅ Better system integration, supports auto-updates
  - 📋 Install command: `sudo dpkg -i InfloWave_0.5.2_amd64.deb`
  - 🔧 Fix dependencies: `sudo apt-get install -f`

**Universal Linux (Works Everywhere)**
- 📥 **[InfloWave_0.5.2_amd64.AppImage](https://github.com/chenqi92/inflowave/releases/download/v0.5.2/InfloWave_0.5.2_amd64.AppImage)**
  - ✅ Works on most x64 Linux distributions
  - ✅ No installation required, run directly
  - ✅ Portable version, doesn't affect system
  - 📋 Usage: `chmod +x InfloWave_0.5.2_amd64.AppImage && ./InfloWave_0.5.2_amd64.AppImage`

**RPM Family (CentOS/RHEL/Fedora)**
- 📥 **[InfloWave-0.5.2-1.x86_64.rpm](https://github.com/chenqi92/inflowave/releases/download/v0.5.2/InfloWave-0.5.2-1.x86_64.rpm)**
  - ✅ CentOS 7+, RHEL 7+, Fedora 30+
  - 📋 Install command: `sudo rpm -i InfloWave-0.5.2-1.x86_64.rpm`
  - 📋 Or use: `sudo dnf install InfloWave-0.5.2-1.x86_64.rpm`
