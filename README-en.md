...
#### Windows Users
- **Recommended**: 📥 **[InfloWave_0.7.4_x64.msi](https://github.com/chenqi92/inflowave/releases/download/v0.7.4/InfloWave_0.7.4_x64.msi)** 
  - ✅ For Windows 10/11 (64-bit systems)
  - ✅ Supports most modern Windows systems
  - ✅ MSI format, simple and reliable installation

- **Legacy**: 📥 **[InfloWave_0.7.4_x86.msi](https://github.com/chenqi92/inflowave/releases/download/v0.7.4/InfloWave_0.7.4_x86.msi)**
  - ✅ For older 32-bit Windows systems
  - ⚠️ Use only if 64-bit version doesn't work

**Portable Versions (No Installation Required)**

- **64-bit Portable**: 📥 **[InfloWave-x64-portable-0.7.4.exe](https://github.com/chenqi92/inflowave/releases/download/v0.7.4/InfloWave-x64-portable-0.7.4.exe)**
  - ✅ Green software, no installation needed
  - ✅ Doesn't write to registry, leaves no traces
  - ✅ Portable, can be run from USB drive
  - ✅ For Windows 10/11 (64-bit)

- **32-bit Portable**: 📥 **[InfloWave-x86-portable-0.7.4.exe](https://github.com/chenqi92/inflowave/releases/download/v0.7.4/InfloWave-x86-portable-0.7.4.exe)**
  - ✅ Green software, no installation needed
...
- 📥 **[InfloWave_0.7.4_amd64.deb](https://github.com/chenqi92/inflowave/releases/download/v0.7.4/InfloWave_0.7.4_amd64.deb)**
  ...
  - 📋 Install command: `sudo dpkg -i InfloWave_0.7.4_amd64.deb`
...
- 📥 **[InfloWave_0.7.4_amd64.AppImage](https://github.com/chenqi92/inflowave/releases/download/v0.7.4/InfloWave_0.7.4_amd64.AppImage)**
  ...
  - 📋 Usage: `chmod +x InfloWave_0.7.4_amd64.AppImage && ./InfloWave_0.7.4_amd64.AppImage`
...
- 📥 **[InfloWave-0.7.4-1.x86_64.rpm](https://github.com/chenqi92/inflowave/releases/download/v0.7.4/InfloWave-0.7.4-1.x86_64.rpm)**
  ...
  - 📋 Install command: `sudo rpm -i InfloWave-0.7.4-1.x86_64.rpm`
  - 📋 Or use: `sudo dnf install InfloWave-0.7.4-1.x86_64.rpm`
