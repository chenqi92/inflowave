...
export class ConnectionAPI {
  ...
  static async createConnection(config: ConnectionConfig): Promise<string> {
    ...
    return safeTauriInvoke<string>('create_connection', {
  ...
  static async testConnection(
    ...
    return safeTauriInvoke<ConnectionTestResult>('test_connection', {
      connectionId,
    });
  }
  ...
  static async getConnection(
    ...
    return safeTauriInvoke<ConnectionConfig | null>('get_connection', {
      connectionId,
    });
  }
  ...
  static async getConnectionStatus(
    ...
    return safeTauriInvoke<ConnectionStatus | null>('get_connection_status', {
      connectionId,
    });
  }
   ...
   * 获取所有连接状态
   */
  static async getAllConnectionStatuses(): Promise<
    Record<string, ConnectionStatus>
  > {
    return safeTauriInvoke<Record<string, ConnectionStatus>>(
   ...
   * 健康检查所有连接
   */
  static async healthCheckAllConnections(): Promise<
    Record<string, ConnectionTestResult>
  > {
    return safeTauriInvoke<Record<string, ConnectionTestResult>>(
   ...
   * 启动连接监控
   */
  static async startConnectionMonitoring(
    intervalSeconds?: number
  ): Promise<void> {
    return safeTauriInvoke<void>('start_connection_monitoring', {
      intervalSeconds,
    });
  }
  ...
  static async getConnectionPoolStats(connection_id: string): Promise<any> {
    return safeTauriInvoke<any>('get_connection_pool_stats', {
...
export class QueryAPI {
  ...
  static async explainQuery(
    ...
    return safeTauriInvoke<string>('explain_query', {
      connectionId: connection_id,
      query,
    });
  }
...
export class DatabaseAPI {
  ...
  static async getDatabases(connection_id: string): Promise<DatabaseInfo[]> {
    return safeTauriInvoke<DatabaseInfo[]>('get_databases', {
      connectionId: connection_id,
    });
  }
  ...
  static async createDatabase(
    ...
    return safeTauriInvoke<void>('create_database', {
      connectionId: connection_id,
      name,
    });
  }
  ...
  static async dropDatabase(
    ...
    return safeTauriInvoke<void>('drop_database', {
      connectionId: connection_id,
      name,
    });
  }
  ...
  static async getMeasurements(
    ...
    return safeTauriInvoke<MeasurementInfo[]>('get_measurements', {
      connectionId: connection_id,
      database,
    });
  }
  ...
  static async getDatabaseStats(
    ...
    return safeTauriInvoke<any>('get_database_stats', {
      connectionId: connection_id,
      database,
    });
  }
...
export class DataWriteAPI {
  ...
  static async importFromFile(
    ...
    return safeTauriInvoke<{ imported: number; errors: string[] }>(
      'import_from_file',
      {
        connectionId: connection_id,
        database,
