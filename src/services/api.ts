...
export class ConnectionAPI {
    ...
    static async getConnectionPoolStats(connection_id: string): Promise<any> {
        return safeTauriInvoke<any>('get_connection_pool_stats', {connectionId: connection_id});
    }
}
...
export class QueryAPI {
    ...
    static async explainQuery(connection_id: string, query: string): Promise<string> {
        return safeTauriInvoke<string>('explain_query', {connectionId: connection_id, query});
    }
}
...
export class DatabaseAPI {
    ...
    static async getDatabases(connection_id: string): Promise<DatabaseInfo[]> {
        return safeTauriInvoke<DatabaseInfo[]>('get_databases', {connectionId: connection_id});
    }
    ...
    static async createDatabase(connection_id: string, name: string): Promise<void> {
        return safeTauriInvoke<void>('create_database', {connectionId: connection_id, name});
    }
    ...
    static async dropDatabase(connection_id: string, name: string): Promise<void> {
        return safeTauriInvoke<void>('drop_database', {connectionId: connection_id, name});
    }
    ...
    static async getMeasurements(connection_id: string, database: string): Promise<MeasurementInfo[]> {
        return safeTauriInvoke<MeasurementInfo[]>('get_measurements', {connectionId: connection_id, database});
    }
    ...
    static async getDatabaseStats(connection_id: string, database: string): Promise<any> {
        return safeTauriInvoke<any>('get_database_stats', {connectionId: connection_id, database});
    }
