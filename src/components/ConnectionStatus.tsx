      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              {getStatusText()} | 
              连续失败: {connectionState.consecutiveFailures} 次
            </CardDescription>
          </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">
                  {stats.successRate > 80 ? '良好' : 
                   stats.successRate > 50 ? '一般' : '较差'}
                </span>
              </div>
          ...
          <>
            ...
            <div>
              ...
              <div className="space-y-1 max-h-32 overflow-y-auto">
                {connectionState.attempts.slice(-10).reverse().map((attempt, index) => (
