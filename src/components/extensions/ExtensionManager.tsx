...
import {Trash2, Plus, PlayCircle, Package, Zap, Webhook, Bot, TestTube} from 'lucide-react';
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex-1">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <Typography.Text
                                                            className="font-medium">{plugin.name}</Typography.Text>
                                        ...
                                        <Card key={integration.id} className="p-4">
                                            <div className="flex items-center justify-between">
                                                <div className="flex-1">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <Typography.Text
                                                            className="font-medium">{integration.name}</Typography.Text>
                                                        <Badge
                                                            variant="secondary">{integration.integration_type}</Badge>
                                                    </div>
                                                    <Typography.Text className="text-muted-foreground">
                                        ...
                                        <Card key={webhook.id} className="p-4">
                                            <div className="flex items-center justify-between">
                                                <div className="flex-1">
                                                    <div className="mb-2">
                                                        <Typography.Text
                                                            className="font-medium">{webhook.name}</Typography.Text>
                                                    </div>
                                                ...
                                                <div className="flex items-center space-x-2 ml-4">
                                                    <Switch checked={webhook.enabled} onCheckedChange={(checked) => toggleWebhook(webhook.id, checked)}/>
                                                </div>
                                            </div>
                                        </Card>
                                    ))}
                                        ...
                                        <Card key={rule.id} className="p-4">
                                            <div className="flex items-center justify-between">
                                                <div className="flex-1">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <Typography.Text
                                                            className="font-medium">{rule.name}</Typography.Text>
                                                        <Badge
                                                            variant="secondary">执行 {rule.execution_count} 次</Badge>
                                                    </div>
                                                    <div className="space-y-1">
                                                        <Typography.Text className="text-muted-foreground">
                                                            {rule.description}
                                                ...
                                                <div className="flex items-center space-x-2 ml-4">
                                                    ...
                                                    <Switch checked={rule.enabled} onCheckedChange={(checked) => toggleAutomationRule(rule.id, checked)}/>
                                                </div>
                                            </div>
                                        </Card>
                                    ))}
