...
import { Button, Form, FormItem, Input, Select, Alert } from '@/components/ui';
    ...
    <div className={fullscreen ? 'fixed inset-0 z-50 bg-background p-4' : ''}>
      ...
      >
        <Form form={form} layout='vertical'>
          ...
          >
            <Textarea rows={4} placeholder='输入 InfluxQL 查询语句' />
          </FormItem>
      ...
      >
        <Form form={settingsForm} layout='vertical'>
          ...
          <FormItem label='刷新间隔 (毫秒)' name='refreshInterval'>
            <Input type='number' placeholder='30000' />
          </FormItem>
        </Form>
      </Modal>
