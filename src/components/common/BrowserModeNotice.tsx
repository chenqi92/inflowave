...
import { Alert, Button, Text, Separator } from '@/components/ui';
      ...
      <div>
        ...
        <div style={{ marginBottom: '32px' }}>
          ...
          <Text className='block mb-4'>
            要体验 InfloWave
            的完整功能，包括真实数据库连接和文件操作，请下载桌面应用版本：
          </Text>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div>
                  <Text className='font-semibold text-sm text-orange-600'>
                    真实数据库连接
                  </Text>
                  <br />
                  <Text className='text-muted-foreground'>
