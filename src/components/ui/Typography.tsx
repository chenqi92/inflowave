...
const AntParagraph = React.forwardRef<HTMLParagraphElement, AntParagraphProps>(
  ({
    ...
    // 向后兼容：type prop映射到variant
    const finalVariant = type === "secondary" ? "muted" : 
...
const H1 = React.forwardRef<HTMLHeadingElement, Omit<HeadingProps, 'level'>>((props, ref) => 
  React.createElement(Heading, { level: 1, ref, ...props })
)
H1.displayName = "H1"

const H2 = React.forwardRef<HTMLHeadingElement, Omit<HeadingProps, 'level'>>((props, ref) => 
  React.createElement(Heading, { level: 2, ref, ...props })
)
H2.displayName = "H2"

const H3 = React.forwardRef<HTMLHeadingElement, Omit<HeadingProps, 'level'>>((props, ref) => 
  React.createElement(Heading, { level: 3, ref, ...props })
)
H3.displayName = "H3"

const H4 = React.forwardRef<HTMLHeadingElement, Omit<HeadingProps, 'level'>>((props, ref) => 
  React.createElement(Heading, { level: 4, ref, ...props })
)
H4.displayName = "H4"

const H5 = React.forwardRef<HTMLHeadingElement, Omit<HeadingProps, 'level'>>((props, ref) => 
  React.createElement(Heading, { level: 5, ref, ...props })
)
H5.displayName = "H5"

const H6 = React.forwardRef<HTMLHeadingElement, Omit<HeadingProps, 'level'>>((props, ref) => 
  React.createElement(Heading, { level: 6, ref, ...props })
)
H6.displayName = "H6"
