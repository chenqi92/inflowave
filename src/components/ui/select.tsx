...
/**
 * SelectContent - JetBrains New UI 风格
 * 4px 圆角, 更紧凑的阴影
 */
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-50 max-h-[--radix-select-content-available-height] min-w-[8rem] overflow-y-auto overflow-x-hidden rounded border bg-popover text-popover-foreground shadow-md',
