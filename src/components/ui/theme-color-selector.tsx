...
// 简化版本的颜色选择器，只显示颜色圆圈
export function SimpleThemeColorSelector({ value, onChange, className }: ThemeColorSelectorProps) {
  const colorOptions = getThemeColorOptions();
...
// 带预览的主题颜色选择器
export function ThemeColorSelectorWithPreview({ value, onChange, className }: ThemeColorSelectorProps) {
  const colorOptions = getThemeColorOptions();
