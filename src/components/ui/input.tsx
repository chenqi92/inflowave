  ...
  ({ className, type, onKeyDown, onChange, ...props }, ref) => {
    ...
    return (
      <input
        type={type}
        className={cn(
          // InfloWave UI: 28px 高度, 4px 圆角, 13px 字体
          'flex h-7 w-full rounded border border-input bg-background px-2 py-1 text-sm ring-offset-background transition-colors duration-100',
