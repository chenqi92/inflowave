  ...
  if (connections.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <Typography variant="h3" className="text-lg text-muted-foreground mb-2">暂无连接配置</Typography>
        <Typography.Text className="text-gray-400">点击"新建连接"开始创建您的第一个数据库连接</Typography.Text>
      </div>
    );
  }
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span className={connection.ssl ? 'text-success' : 'text-gray-400'}>
