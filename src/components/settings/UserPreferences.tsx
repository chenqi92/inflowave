...
const getAllSystemShortcuts = (): KeyboardShortcut[] => {
  return [
    // 导航快捷键
    { id: 'nav_dashboard', name: '打开仪表板', description: '切换到仪表板页面', keys: ['Ctrl', '1'], category: '导航', enabled: true },
    { id: 'nav_connections', name: '打开连接管理', description: '切换到连接管理页面', keys: ['Ctrl', '2'], category: '导航', enabled: true },
    { id: 'nav_query', name: '打开数据查询', description: '切换到数据查询页面', keys: ['Ctrl', '3'], category: '导航', enabled: true },
    { id: 'nav_database', name: '打开数据库管理', description: '切换到数据库管理页面', keys: ['Ctrl', '4'], category: '导航', enabled: true },
    { id: 'nav_visualization', name: '打开数据可视化', description: '切换到数据可视化页面', keys: ['Ctrl', '5'], category: '导航', enabled: true },
    { id: 'nav_performance', name: '打开性能监控', description: '切换到性能监控页面', keys: ['Ctrl', '6'], category: '导航', enabled: true },
    { id: 'nav_settings', name: '打开应用设置', description: '切换到应用设置页面', keys: ['Ctrl', '7'], category: '导航', enabled: true },

    // 文件操作快捷键
    { id: 'file_new_query', name: '新建查询', description: '创建新的SQL查询', keys: ['Ctrl', 'N'], category: '文件', enabled: true },
    { id: 'file_new_connection', name: '新建连接', description: '创建新的数据库连接', keys: ['Ctrl', 'Shift', 'N'], category: '文件', enabled: true },
    { id: 'file_save_query', name: '保存查询', description: '保存当前查询', keys: ['Ctrl', 'S'], category: '文件', enabled: true },
    { id: 'file_open_query', name: '打开查询', description: '打开已保存的查询', keys: ['Ctrl', 'O'], category: '文件', enabled: true },

    // 查询操作快捷键
    { id: 'query_execute', name: '执行查询', description: '执行当前查询', keys: ['Ctrl', 'Enter'], category: '查询', enabled: true },
    { id: 'query_stop', name: '停止查询', description: '停止正在执行的查询', keys: ['Ctrl', 'Shift', 'C'], category: '查询', enabled: true },
    { id: 'query_format', name: '格式化查询', description: '格式化SQL查询代码', keys: ['Ctrl', 'L'], category: '查询', enabled: true },

    // 编辑操作快捷键
    { id: 'edit_copy_line', name: '复制当前行', description: '复制光标所在行', keys: ['Ctrl', 'D'], category: '编辑', enabled: true },
    { id: 'edit_toggle_comment', name: '切换注释', description: '注释/取消注释选中行', keys: ['Ctrl', '/'], category: '编辑', enabled: true },

    // 搜索快捷键
    { id: 'search_global', name: '全局搜索', description: '打开全局搜索', keys: ['Ctrl', 'Shift', 'P'], category: '搜索', enabled: true },

    // 工具快捷键
    { id: 'tools_shortcuts', name: '显示快捷键帮助', description: '显示所有快捷键', keys: ['Ctrl', 'K'], category: '工具', enabled: true },
    { id: 'tools_dev_tools', name: '切换开发者工具', description: '打开/关闭开发者工具', keys: ['F12'], category: '工具', enabled: true },

    // 界面操作快捷键
    { id: 'layout_toggle_sidebar', name: '切换侧边栏', description: '显示/隐藏侧边栏', keys: ['Ctrl', 'B'], category: '界面', enabled: true },
    { id: 'layout_refresh', name: '刷新页面', description: '刷新当前页面', keys: ['F5'], category: '界面', enabled: true },

    // 视图操作快捷键
    { id: 'view_zoom_in', name: '放大', description: '放大界面', keys: ['Ctrl', '+'], category: '视图', enabled: true },
    { id: 'view_zoom_out', name: '缩小', description: '缩小界面', keys: ['Ctrl', '-'], category: '视图', enabled: true },
    { id: 'view_reset_zoom', name: '重置缩放', description: '重置界面缩放', keys: ['Ctrl', '0'], category: '视图', enabled: true },

    // 数据库操作快捷键
    { id: 'db_refresh', name: '刷新数据库结构', description: '刷新数据库树结构', keys: ['F5'], category: '数据库', enabled: true },
    { id: 'db_delete', name: '删除选中项', description: '删除选中的数据库项', keys: ['Delete'], category: '数据库', enabled: true },
    { id: 'db_rename', name: '重命名选中项', description: '重命名选中的数据库项', keys: ['F2'], category: '数据库', enabled: true },
    { id: 'db_new_table', name: '创建新表', description: '创建新的数据表', keys: ['Ctrl', 'T'], category: '数据库', enabled: true },
  ];
};
  ...
  const loadPreferences = async () => {
    ...
    try {
      ...
      if (result) {
        ...
        const preferences = {
          ...result,
          shortcuts: result.shortcuts && result.shortcuts.length > 0 ? result.shortcuts : getAllSystemShortcuts()
        };
          ...
          <div>
            ...
            <div>
              <div className="space-y-6">
                {/* 按分类分组显示快捷键 */}
                {Object.entries(
                  form.watch('shortcuts')?.reduce((groups, shortcut) => {
