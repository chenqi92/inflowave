  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='flex items-center gap-3 mb-4'>
        ...
        <div>
          <h2 className='text-2xl font-bold'>{tSettings('language_management')}</h2>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
        <div className='p-4 border rounded-lg'>
          <div className='text-sm text-muted-foreground'>{tSettings('available_languages')}</div>
          <div className='text-2xl font-bold mt-1'>{availableLanguages.length}</div>
        </div>
        <div className='p-4 border rounded-lg'>
          <div className='text-sm text-muted-foreground'>{tCommon('enabled')}</div>
          <div className='text-2xl font-bold mt-1'>
            {availableLanguages.filter(lang => lang.enabled).length}
          </div>
        </div>
        <div className='p-4 border rounded-lg'>
          <div className='text-sm text-muted-foreground'>{tSettings('translation_progress')}</div>
          <div className='text-2xl font-bold mt-1'>
            {Math.round(
