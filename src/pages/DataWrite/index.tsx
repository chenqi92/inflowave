        ...
        return (
            <div className="p-6">
                <Alert>
                    ...
                    <AlertDescription>
                        请先连接到 InfluxDB。在连接管理页面选择一个连接并激活后，才能写入数据。
                    </AlertDescription>
                </Alert>
            </div>
        );
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    <Typography.Title level={2} className="text-2xl font-bold mb-1">数据写入</Typography.Title>
            ...
            <Tabs defaultValue="single" className="w-full">
                ...
                <TabsContent value="single" className="space-y-6">
                    <div className="space-y-6">
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(writeSinglePoint)} className="space-y-6">
                                <Row gutter={16}>
                                    <Col span={12}>
                                        <FormField
                                            control={form.control}
                ...
                <TabsContent value="batch" className="space-y-6">
                    <div className="space-y-6">
                        ...
                        <Form {...batchForm}>
                            <form onSubmit={batchForm.handleSubmit(handleLineProtocolSubmit)} className="space-y-4">
                                <FormField
...
memory,host=server01 used_bytes=8589934592,available_bytes=4294967296`}
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <h3 className="text-lg font-medium">批次数据点 ({dataPoints.length})</h3>
                                <div className="flex gap-2">
                                    <Button
                                        variant="outline"
