                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            <div className="flex gap-2">
                                                                ...
                                                                <div>
                                                                    <div
                                                                        className="font-medium text-sm">{connection.name}</div>
                                    ...
                                    <div className="desktop-panel-content">
                                        <Row gutter={[16, 16]}>
                                            <Col xs={24} sm={12} lg={8}>
                                                <div
                                                    className="text-center hover:shadow-md transition-shadow cursor-pointer p-4 border rounded-lg bg-card">
                                                    <Webhook className="w-4 h-4" style={{
                                                        fontSize: 28,
                                                        color: '#1890ff',
                                                        marginBottom: 12
                                                    }}/>
                                            ...
                                            <Col xs={24} sm={12} lg={8}>
                                                <div
                                                    className="text-center hover:shadow-md transition-shadow cursor-pointer p-4 border rounded-lg bg-card">
                                                    <BarChart className="w-4 h-4" style={{
                                                        fontSize: 28,
                                                        color: '#fa8c16',
                                                        marginBottom: 12
                                                    }}/>
