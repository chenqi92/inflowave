      ...
      <div className="h-full">
        <Tabs defaultValue="data-generator" className="h-full flex flex-col">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="data-generator" className="flex items-center gap-2">
          ...
          <TabsContent value="data-generator" className="flex-1 mt-4 overflow-hidden">
            <div className="h-full overflow-y-auto">
              <DataGenerator />
            </div>
          </TabsContent>

          <TabsContent value="error-logs" className="flex-1 mt-4 overflow-hidden">
            <div className="h-full overflow-y-auto">
              <ErrorLogViewer />
            </div>
          </TabsContent>
